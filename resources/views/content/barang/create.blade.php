        ...
        <nav aria-label="breadcrumb" class="mt1">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <a href="#">Create Barang</a>
                </li>
            </ol>
        </nav><!-- /Breadcrumbs -->
        <!-- Page Title -->
        <div class="page-title page-title-custom mt2 mb2">
            <h3 class="breadcrumb-header mb0">Create Barang</h3>
        </div> <!-- /Page Title -->
        <div id="box"></div>
        <div id="main-wrapper">
            <form method="POST" action="{{ route('barang-create') }}">
                <div class="audience-lists">
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input autocomplete="off" type="text" name="harga" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <textarea  type="text" name="deskripsi" rows="3" class="form-control"></textarea>
                            </div>
                        </div>
